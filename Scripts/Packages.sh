...
UPDATE_PACKAGE "filetransfer" "sirpdboy/luci-app-filetransfer" "main"
UPDATE_PACKAGE "nas-packages" "linkease/nas-packages" "master" "name"
UPDATE_PACKAGE "nas-packages-luci" "linkease/nas-packages-luci" "main" "name"
